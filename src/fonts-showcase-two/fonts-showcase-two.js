class FontsShowcaseTwo extends Polymer.Element {

  static get is() { return 'fonts-showcase-two'; }
  ...
  **/
  ...
  /**
   * Fired when fonts-showcase-two does something
   *
   * @event fonts-showcase-two-action
   */
};

customElements.define(FontsShowcaseTwo.is, FontsShowcaseTwo);
